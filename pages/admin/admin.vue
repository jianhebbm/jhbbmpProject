<template>
	<view style="display: flex;flex-direction: row;">
		<!-- 管理功能选项栏 -->
		<view style="display: flex;flex-direction: column;width: 180upx;background-color: #001529; border-bottom: #FFFFFF 2px solid;">
			<image src="/static/jhbbm.png" mode="widthFix" class="admin_pic"></image>
